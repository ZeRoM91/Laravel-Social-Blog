    ...
    @foreach($articles as $article)
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-footer">
                ...
                <span class="glyphicon glyphicon-eye-open" style="color: #61788f;"></span><span> {{$article ->views}}</span>
                <span class="glyphicon glyphicon-heart" style="color: #61788f;"></span><span> {{$article ->rating}}</span>
                <span class="glyphicon glyphicon-comment" style="color: #61788f;"></span><span> {{$article ->comment->count()}}</span>
            </div>
        </div>
