...
@section('content')
    ...
    <form method="post" id="message">
        {{ csrf_field() }}
        <textarea type="text" name="message" id="message3" class="form-control"
                  placeholder="Введите ваше сообщение. Для отправки сообщения нажмите [Enter]" rows="4"
                  style="resize: none"></textarea>                    </textarea>
        <br>
        <button type="submit" class="btn btn-info" value="Отправить" id="send"><span
