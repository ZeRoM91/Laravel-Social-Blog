...
@section('content')
    <div class="col-md-8 col-md-offset-2">
        <form class="form" method="post">
            ...
            <button type="submit" class="btn btn-default"><span class="glyphicon glyphicon-plus"></span> Создать
            </button>
        </form>
        <hr>
        <form class="form" method="post">
            ...
            {{--</div>--}}
            <br>
            <button type="submit" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Удалить
            </button>
        </form>
    </div>
    </div>
